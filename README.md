...
```
- **模型目录**
<img width="245" height="412" alt="1" src="https://github.com/user-attachments/assets/cbc17021-6fa0-4fcd-9284-7a0b5c74d6b0" />
...
- **5.Lora_train.py**: 对Qwen-2.5-7B-Instruct模型进行Lora微调。
